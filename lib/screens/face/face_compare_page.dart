...
class _FaceComparePageState extends State<FaceComparePage> {
  ...
  Future<void> _compareFaces() async {
    ...
    try {
      final input1 = InputImage.fromFile(_image1!);
      final input2 = InputImage.fromFile(_image2!);
      final faces1 = await _faceDetector.processImage(input1);
      final faces2 = await _faceDetector.processImage(input2);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Constants.primaryColor,
        title: const Text('Face Compare', style: TextStyle(color: Colors.white)),
        elevation: 0,
      ),
      body: SafeArea(
                  ...
                  children: [
                    ...
                    if (_similarity != null) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _similarity! >= 70 ? Colors.green.withOpacity(0.1) : Colors.red.withOpacity(0.1),
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
          ...
          child: Container(
            ...
            child: image != null
                ...
                : Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.add_a_photo, color: Constants.accentColor, size: 40),
                      const SizedBox(height: 8),
                      Text('Add \$label', style: TextStyle(color: Constants.accentColor, fontWeight: FontWeight.w500)),
                    ],
                  ),
          ),
        ),
